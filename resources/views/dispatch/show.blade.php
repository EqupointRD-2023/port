...
@section('content')
    ...
    <div class="row">
            ...
            <div class="page-content fade-in-up">
                <div class="row">
                    <div class="col-md-12">
                        <div class="ibox">
                            <div class="ibox-head">
                                <div class="ibox-title">Dispatch Info</div>
                            </div>
                                    ...
                                    <tbody>
                                        @foreach ($dispatch as $key => $dt)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="" type="button" class="btn btn-warning  pull-right"
                                                        data-toggle="modal" data-target="#show{{ $dt->id }}">
                                                        Edit</a>
                                                </td>
                                            </tr>
                                        @endforeach
        ...
        {{-- <div id="customer" class="modal fade" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <form action="{{ route('dispatch-update',) }}" method="POST">
                        {{ csrf_field() }}
        ...
        <div id="show{{ $dt->id }}" class="modal fade" role="dialog">
            <div class="modal-dialog">
                <!-- Modal content-->
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <form action="{{ route('dispatch-update', $dispatch_id[0]->id) }}" method="POST">
                        {{ csrf_field() }}
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div>
                                        ...
                                        <input type="text" class="form-control"
                                            value="{{ $dt->device[0]->Devicenumber }}" name="devicenumber"
                                            placeholder="ENTER LIST OF DEVICE" required>
                                        @error('devicenumber')
                                            <p class="text-danger">
                                                {{ $message }}
