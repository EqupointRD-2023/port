                                    ...
                                    <tbody>
                                        @foreach ($dispatch as $key => $dt)
                                            <tr>
                                                ...
                                                <td>{{ $dt->user->name }}</td>
                                                <td><a
                                                        href="{{ route('dispatch-show', $dt->dispatch->dispatchNo) }}">{{ $dt->dispatch->dispatchNo }}</a>
                                                </td>
                                                    ...
                                                    @if ($dt->status == 0)
                                                        <div class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <form
                                                                    action="{{ route('stock-from-port-receive', $dt->dispatch->dispatchNo) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    <button class="button-like-text"
                                                                        style="border: none; background:none">Receive</button>
                                                                </form>
