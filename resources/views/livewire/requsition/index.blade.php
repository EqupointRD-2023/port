                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="text-muted font-14 mb-3">
                                KeyTable provides Excel like cell navigation on any table. Events (focus, blur, action etc)
                                can be assigned to individual cells, columns, rows or all cells.
                            </p>
                    ...
                    <div class="card">
                        <div class="card-body table-responsive">
                            ...
                            <p class="text-muted font-14 mb-3">
                                ...
                                state without effecting other rows, unlike the os and single options shown in other
                                examples.
                            </p>
