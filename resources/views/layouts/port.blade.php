        ...
        <nav class="page-sidebar" id="sidebar">
            <div id="sidebar-collapse">
                ...
                <ul class="side-menu metismenu">
                    ...
                    <li>
                        <a class="" href="{{ route('requsition-port') }}"><i
                    ...
                    <li>
                        <a class="active" href=""><i class="sidebar-item-icon fa fa-database"></i>
                            <span class="nav-label">My Stock</span>
                        </a>
                    </li>

                    <li>
                        <a class="" href=""><i class="sidebar-item-icon fa fa-folder-open"></i>
                            <span class="nav-label">Receive Device</span>
                        </a>
                    </li>
                    <li>
                        <a class="" href=""><i class="sidebar-item-icon fa fa-folder-open"></i>
                            <span class="nav-label">Return Device</span>
                        </a>
                    </li>
