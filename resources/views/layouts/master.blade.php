        ...
        <nav class="page-sidebar" id="sidebar">
            <div id="sidebar-collapse">
                ...
                <ul class="side-menu metismenu">
                    ...
                    <li>
                        <a class="active" href="{{ url('/dashboard') }}"><i
                    ...
                    {{-- <li>
                        ...
                        <ul class="nav-2-level collapse">
                            ...
                            <li>
                                <a href="{{ route('rts.port') }}">Orders</a>
                            </li>
                    ...
                    <li>
                        <a class="active" href="{{ url('device/register') }}"><i
                    ...
                    <li>
                        <a class="active" href="{{ route('transfer.device') }}"><i
                    ...
                    <li>
                        <a class="active" href="{{ route('store.dashboard') }}"><i
                                class="sidebar-item-icon fa fa-database"></i>
                            <span class="nav-label">Device Stock</span>
                        </a>
                    </li>

                    <li>
                        <a class="" href="{{ route('all.requisition') }}"><i
                    ...
                    <li>
                        <a class="" href="{{ route('issuing') }}"><i
                                class="sidebar-item-icon fa fa-folder-open"></i>
                            <span class="nav-label">Issuing</span>
                        </a>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="nav-2-level collapse">
                            ...
                            <li>
                                <a href="{{ route('returndevicefromborder') }}"> Border</a>
                            </li>
                            <li>
                                <a href="{{ route('rts.port') }}">Port</a>
                            </li>
                    ...
                    <li>
                        <a class="active" href="{{ route('tracedevice') }}"><i
                                class="sidebar-item-icon fa fa-map"></i>
                            <span class="nav-label">Tracking Device</span>
                        </a>
                    </li>
                    @can('role-edit')
                        <li>
                            <a class="active" href="{{ route('search.receive') }}"><i
                    ...
                    <li>
                        <a class="active" href="{{ route('quick.search') }}"><i
                                class="sidebar-item-icon fa fa-search"></i>
                    ...
                    <li>
                        ...
                        <ul class="nav-2-level collapse">
                            ...
                            <li>
                                <a href="{{ route('rotate.device') }}"> Device location status</a>
                            </li>
                            <li>
                                <a href="{{ route('rotation.status') }}">Latest Device Efficiency</a>
                            </li>
                    ...
                    <li>
                        <a class="active" href="{{ route('technicalHome') }}"><i
                                class="sidebar-item-icon fa fa-map-marker"></i>
                    ...
                    <li>
                        ...
                        <ul class="nav-2-level collapse">
                            ...
                            <li>
                                <a href="{{ route('account.report') }}"> Leasing Report</a>
                            </li>

                            <li>
                                <a href="{{ route('issued.view') }}">Issued Report</a>
                            </li>
                            <li>
                                <a href="javascript:;">Receiving Report</a>
                            </li>
                            <li>
                                <a href="{{ route('return_border_report') }}">Returned Border Report</a>
                            </li>
                            <li>
                                <a href="{{ route('return_port_report') }}">Returned Port Report</a>
                            </li>

                            <li>
                                <a href="{{ route('return_device_stock') }}">Device Stock Report</a>
                            </li>
                    ...
                    <li>
                        ...
                        <ul class="nav-2-level collapse">
                            ...
                            <li>
                                <a href="{{ url('customers/index') }}">Customer</a>
                            </li>
                            <li>
                                <a class="" href="{{ url('department/index') }}"> Department</a>
                            </li>
                            <li>
                                <a href="{{ route('location') }}">Untag Point(Border)</a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="{{ route('tag.point') }}">Tagging Point(Depot)</a>
                            </li>
                        </ul>
                    </li>
